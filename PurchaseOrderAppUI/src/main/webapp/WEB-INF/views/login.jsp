...
<link href="poui/static/css/po-admin.min.css" rel="stylesheet">
</head>
...
<body class="bg-gradient-primary">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="p-5">
											...
											<form:form action="poui/login" method="post" modelAttribute="loginForm" class="user" id="user">
	...
	<script src="poui/static/js/jquery.min.js"></script>
	<script src="poui/static/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Custom scripts for all pages-->
	<script src="poui/static/js/po-admin.min.js"></script>
	<script src="poui/static/js/config.js"></script>
